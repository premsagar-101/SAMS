...
// Static methods
studentEnrollmentSchema.statics.findByStudent = function(studentId: mongoose.Types.ObjectId) {
...
studentEnrollmentSchema.statics.findBySubject = function(subjectId: mongoose.Types.ObjectId) {
...
studentEnrollmentSchema.statics.findBySemester = function(semesterId: mongoose.Types.ObjectId) {
...
studentEnrollmentSchema.statics.getStudentCountBySubject = function(subjectId: mongoose.Types.ObjectId) {
  return this.countDocuments({ subject: subjectId, isActive: true });
};

studentEnrollmentSchema.statics.getStudentCountBySemester = function(semesterId: mongoose.Types.ObjectId) {
